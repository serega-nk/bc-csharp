...
namespace Org.BouncyCastle.Crypto.Operators
{
	internal class X509Utilities
	{
		...
		static X509Utilities()
		{
			...
			// Add Gost2012
			//
			algorithms.Add("GOST3411-2012-256WITHGOST3410-2012-256", RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_256);
			algorithms.Add("GOST3411-2012-512WITHGOST3410-2012-512", RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_512);
			//
