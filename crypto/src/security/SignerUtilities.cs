...
namespace Org.BouncyCastle.Security
{
    ...
    public sealed class SignerUtilities
    {
        ...
        static SignerUtilities()
        {
            ...
            // Add Gost2012
            //
            algorithms[RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_256.Id] = "GOST3411-2012-256WITHGOST3410-2012-256";
            algorithms[RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_512.Id] = "GOST3411-2012-512WITHGOST3410-2012-512";
            //
            ...
            // Add Gost2012
            //
            oids["GOST3411-2012-256WITHGOST3410-2012-256"] = RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_256;
            oids["GOST3411-2012-512WITHGOST3410-2012-512"] = RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_512;
            //
            ...
            string algorithm)
        {
            ...
            // Add Gost2012
            //
            if (mechanism.Equals("GOST3411-2012-256WITHGOST3410-2012-256"))
            {
                return new Gost3410DigestSigner(new ECGost3410Signer(), new Gost3411_2012_256Digest());
            }
            if (mechanism.Equals("GOST3411-2012-512WITHGOST3410-2012-512"))
            {
